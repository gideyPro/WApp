...
class CarService {
  ...
  Future<FormData> _buildFormData(CarFormData formData, {bool isUpdate = false}) async {
    ...
    dioFormData.fields.addAll([
      ...
      if (formData.transmission.isNotEmpty) MapEntry('transmission', formData.transmission),
      if (formData.bodyType.isNotEmpty) MapEntry('body_type', formData.bodyType),
      if (formData.fuelType.isNotEmpty) MapEntry('fuel_type', formData.fuelType),
      if (formData.engineSize.isNotEmpty) MapEntry('engine_size', formData.engineSize),
